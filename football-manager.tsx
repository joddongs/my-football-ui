                  ...
                  <Card className="w-full">
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <Info size={16} className="text-blue-600" />
                        <h4 className="font-semibold text-gray-700">포지션별 상세 현황</h4>
                      </div>
      ...
      <footer className="bg-gray-50 border-t mt-12">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            ...
            <div className="lg:w-1/3">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-lg">Goalfolio</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                자산 목표(Goal) 달성을 위한 투자 포트폴리오를 축구 경기 형식으로 관리하는 서비스입니다.
                투자 현황을 한눈에 파악하고 효율적으로 관리하세요.
              </p>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <Mail size={14} />
                <span>문의: joddong@gmail.com</span>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 mt-6 pt-6">
            <div className="flex flex-col lg:flex-row justify-center items-center text-sm text-gray-500 text-center gap-2">
              <p>&copy; 2024 Goalfolio. All rights reserved.</p>
              <p className="mt-2 lg:mt-0">
                본 서비스는 투자 조언을 제공하지 않으며, 투자 결정은 사용자의 판단에 따라 이루어져야 합니다.
              </p>
            </div>
          </div>
        </div>
